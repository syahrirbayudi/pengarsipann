        ...
        <ul class="nav navbar-nav navbar-left">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu tipe-kiri dropdown-menu-login2">
              <li><a href="<?php echo base_url(); ?>administrasi/data_obat"><i class="fa fa-tags"></i> Daftar Bus</a></li>
              <li><a href="<?php echo base_url(); ?>administrasi/data_penyakit"><i class="fa fa-tags"></i> Daftar Tujuan</a></li>
              <li><a href="<?php echo base_url(); ?>administrasi/data_puskesmas"><i class="fa fa-tags"></i> Daftar Loket</a></li>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu tipe-kiri dropdown-menu-login2">
              <li><a href="<?php echo base_url(); ?>administrasi/data_jumlah_penyakit_puskesmas"><i class="fa fa-tags"></i> Jumlah Penumpang Per Loket</a></li>
              <li><a href="<?php echo base_url(); ?>administrasi/data_jumlah_fasilitas_puskesmas"><i class="fa fa-tags"></i> Jumlah Fasilitas Per Loket</a></li>
              <li><a href="<?php echo base_url(); ?>administrasi/data_jumlah_obat_puskesmas"><i class="fa fa-tags"></i> Jumlah Ketersediaan Bus Per Loket</a></li>
            </ul>
          </li>
        </ul>
